...
public class ModCreativeModeTabs {
    public static final DeferredRegister<CreativeModeTab> CREATIVE_MODE_TAB =
        DeferredRegister.create(Registries.CREATIVE_MODE_TAB, artificialsolaris.MOD_ID);

    public static final Supplier<CreativeModeTab> ARTIFICIALSOLARIS =
            CREATIVE_MODE_TAB.register("artificialsolaris",
                    () -> CreativeModeTab.builder().icon(() -> new ItemStack(ModItems.WRENCH.get()))
                            .title(Component.translatable("creativetab.artificialsolaris.artificialsolaris"))
